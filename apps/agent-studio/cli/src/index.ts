...
async function initWorkspace(root: string, args: string[]) {
  ...
  console.log(`  4. Edit ${config.deploymentsDir}/shared for deployment-wide defaults`);
  console.log(`  5. Edit ${config.deploymentsDir}/instances/000 for per-instance overrides`);
